...
public class DocxStamper<T> {
  ...
  private void initFields() {
    ...
    commentProcessorRegistry.registerCommentProcessor(IRepeatProcessor.class, new RepeatProcessor(typeResolverRegistry, expressionResolver, config.isLeaveEmptyOnExpressionError(), config.isReplaceNullValues()));
